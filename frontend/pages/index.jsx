...
export default function Home() {
  ...
  const contractAddress = "0x1EC717dd24c52943E3E347987a0b4B822b05B643";
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Buy deafmice a Coffee!</title>
      ...
      <main className={styles.main}>
        <h1 className={styles.title}>
          Buy deafmice a small or LARGE Coffee!
        </h1>
        

<table>
  <tr>
    <th>Small Coffee Form</th>
    <th>or</th>
    <th>Large Coffee Form</th>
  </tr>
  <tr>
    <td>
        {currentAccount ? (
          ...
          <div>
            <form>
              ...
              <div>
                <label>
                  Send deafmice a message
                </label>
                <br/>

                <textarea
                  rows={3}
                  placeholder="Enjoy your small coffee!"
                  id="message"
